...
#         axes[1].plot(delays, MSD_X, color = ColorStyle[Organism], linewidth = 2, label = Organism, alpha = 0.7)
        ...
        axes[0].plot(delays[::60],RMSD_Z_bySize[::60], color = ColorStyle[Organism], marker = MarkerStyle[Organism], MarkerSize = 10, label = Organism, alpha = 0.7)
        axes[1].plot(delays[::60], RMSD_X_bySize[::60], color = ColorStyle[Organism], marker = MarkerStyle[Organism], MarkerSize = 10, label = Organism, alpha = 0.7)
...
#         axes[1].plot(delays, MSD_X, color = ColorStyle[Organism], linewidth = 2, label = Organism, alpha = 0.7)
        ...
        axes[0].scatter(delays[::30],RMSD_Z[::30], 10, color = ColorStyle[Organism], marker = MarkerStyle[Organism], label = Organism, alpha = 0.7)
        axes[1].scatter(delays[::30], RMSD_X[::30], 10, color = ColorStyle[Organism], marker = MarkerStyle[Organism], label = Organism, alpha = 0.7)

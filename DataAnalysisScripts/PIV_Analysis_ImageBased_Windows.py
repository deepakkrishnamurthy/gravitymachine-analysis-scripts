...
#    thresh_high = [255,255,255]
    ...
    # Sea Cucumber
    #--------------------------------------------------------------------------
    path = 'F:\GravityMachineBackup\HopkinsEmbryologyCourse\2018_06_07\Sea_Cucumber\seacucmber9_Auto'
#    path = '/Volumes/GRAVMACH1 1/HopkinsEmbroyologyCourse_GoodData/2018_06_07/seacucmber9_Auto'
...
#    path = '/Volumes/GRAVMACH1/HopkinsEmbroyologyCourse_GoodData/2018_06_12/Starfish/StarFish6highfreq'
    ...
    wdir = 'D:\GravityMachineLocal\HopkinsResults\PIV_Results'
...
#    print("{:~^50} {}".format('No:of Data points:',nData))
    ...
    if(AnalysisDict[AnalysisType] is 'ImageBasedSeq'):
        ...
        startImageIndex = int(np.array(np.nonzero(Track1.ImageName[imageIndex] == startImage_str)))
        stopImageIndex = int(np.array(np.nonzero(Track1.ImageName[imageIndex] == stopImage_str)))
...
#            print('ImagePairs: {}, {}'.format(Track1.ImageName[ImagePairs[ii][0]], Track1.ImageName[ImagePairs[ii][1]]))
        ...
        focusMeasureMask = Track1.focusMeasure >= focusMeasureMean + 1.5*focusMeasureStd
...
#            #--------------------------------------------------------------------------
        ...
        u_fine,v_fine = (data2RealUnits(u_fine,scale = mmPerPixel(imW)), data2RealUnits(v_fine,scale = mmPerPixel(imW)))
        #--------------------------------------------------------------------------

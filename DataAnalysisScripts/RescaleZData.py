...
#    dataFolder = 'F:\GravityMachineBackup\HopkinsEmbryologyCourse\2018_06_06\AcornWorm_Experiment1_nolight'
    
    dataFolder = 'L:/HopkinsEmbroyologyCourse_GoodData/2018_06_12/Dendraster_Embryo'
    TrackNames = {0:'Dendraster_Embryo2'}
    
    Tracks = os.listdir(dataFolder)
    
    for ii in Tracks:
        print('Analyzing {} ... '.format(Tracks))
    ...
    for mm, TrackFolder in TrackNames.items():
